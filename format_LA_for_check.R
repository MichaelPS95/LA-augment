...
format_file <- function(LA=NULL, params=NULL, flags=NULL){
  ...
  # already in the proper format to be checked (since I will need these to parameters
  # to fix the format)
  if(is.null(params)){
    command <- paste("./check", flags, "<", LA, "> check_output.txt",sep=" ")
    print(command)
...
format_file("/home/michael/Desktop/Array-Checker/Sample-Input/Colbourn1.tsv")
format_file("/home/michael/Desktop/Array-Checker/Sample-Input/Colbourn1.tsv", flags="-vs")
